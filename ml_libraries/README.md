...
1. **Open a terminal in this folder (`ml_libraries`).**
...
2. Open a terminal in this folder (`ml_libraries`).
...
3. Click "New app", connect your GitHub repo, and select the branch and `ml_libraries/app.py` as the main file.
4. Click "Deploy". Streamlit Cloud will install dependencies from `requirements.txt` and launch your app.

---

Enjoy learning about Data Science Libraries interactively!
